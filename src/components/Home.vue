    ...
    data() {
        return {
            ...
            iconsObject: {
              ...
              '3':'iconfont icon-xiugai',
              '4':'iconfont icon-yundong',
              '5':'iconfont icon-pingtai',
              '101':'iconfont icon-kaluli',
              ...
              '204':'iconfont icon-a-biaodanliebiao-03',
            },
            isCollapse:false,
            // 被激活的连接
            activePath:'',
